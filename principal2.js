...
// Tableau de couleurs
var a_Nom_Couleur = ["", "Green", "cyan", "red", "yellow", "orange", "maroon"];
...
// pour stocker la solution avec les BP
...
function action_au_click1() {
    if (document.getElementById("btnCouleur1").tag == 1) {
        ...
        document.getElementById("btnCouleur1").style.backgroundColor = "orange";
        document.getElementById("btnCouleur1").tag++;
        ...
        document.getElementById("btnCouleur1").style.backgroundColor = "red";
        document.getElementById("btnCouleur1").tag++;
    } else if (document.getElementById("btnCouleur1").tag == 5) {
        document.getElementById("btnCouleur1").style.backgroundColor = "maroon";
        document.getElementById("btnCouleur1").tag++;
    } else {
...
function action_au_click2() {
    if (document.getElementById("btnCouleur2").tag == 1) {
        ...
        document.getElementById("btnCouleur2").style.backgroundColor = "orange";
        document.getElementById("btnCouleur2").tag++;
        ...
        document.getElementById("btnCouleur2").style.backgroundColor = "red";
        document.getElementById("btnCouleur2").tag++;
    } else if (document.getElementById("btnCouleur2").tag == 5) {
        document.getElementById("btnCouleur2").style.backgroundColor = "maroon";
        document.getElementById("btnCouleur2").tag++;
    } else {
...
function action_au_click3() {
    if (document.getElementById("btnCouleur3").tag == 1) {
        ...
        document.getElementById("btnCouleur3").style.backgroundColor = "orange";
        document.getElementById("btnCouleur3").tag++;
        ...
        document.getElementById("btnCouleur3").style.backgroundColor = "red";
        document.getElementById("btnCouleur3").tag++;
    } else if (document.getElementById("btnCouleur3").tag == 5) {
        document.getElementById("btnCouleur3").style.backgroundColor = "maroon";
        document.getElementById("btnCouleur3").tag++;
    } else {
...
function action_au_click4() {
    if (document.getElementById("btnCouleur4").tag == 1) {
        ...
        document.getElementById("btnCouleur4").style.backgroundColor = "orange";
        document.getElementById("btnCouleur4").tag++;
        ...
        document.getElementById("btnCouleur4").style.backgroundColor = "red";
        document.getElementById("btnCouleur4").tag++;
    } else if (document.getElementById("btnCouleur4").tag == 5) {
        document.getElementById("btnCouleur4").style.backgroundColor = "maroon";
        document.getElementById("btnCouleur4").tag++;
    } else {
...
var action_au_click_valider = function () {
    ...
    var i, buttonsToCreate, newButton, newlabel;

    buttonsToCreate = ['button1', 'button2', 'button3', 'button4', 'button5', 'button6'];
    
    // ajout dynamique d'un label
    newlabel = document.getElementById("nbessai");
    ...
    for (i = 0; i < 4; i++) {
        ...
        // document.getElementById('pourmoi').appendChild(newButton);
        document.getElementById('pourmoi').appendChild(newButton) ;
    }
    ...
    var iNbMP = 0;  // compter les mal placés
    ...
    if (iNbBP == 4) {
        ...
        newlabel.innerHTML += " Essai " + iCptEssai + " : " + "Vous avez " + iNbBP + " bien placé(s) et " + iNbMP + " mal placé(s)";
        if (iCptEssai == 10) {
